...
var main_body = main_content.parentNode;
	...
	if (document.getElementById){
		...
		var preview_header_text = document.createTextNode('Náh¾ad stránky pred tlaèou.');
		preview_header.appendChild(preview_header_text);
		
		// Create paragraph
		var preview_para = document.createElement('p');
		var preview_para_text = document.createTextNode('Samozrejme okrem tejto správy. ');
		...
		var cancel_function_link_text = document.createTextNode('Návrat na pôvodnú stránku.');
