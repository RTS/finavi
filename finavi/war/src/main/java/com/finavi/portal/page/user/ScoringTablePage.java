...
public class ScoringTablePage extends AutheticatedPage{
	...
	public ScoringTablePage() {
		...
		collumns.add(new PropertyColumn<Scoring>(new Model<String>("Poplatok účtu"), "accountFee"));
		collumns.add(new PropertyColumn<Scoring>(new Model<String>("Mesačná splátka"), "loanProcessCharge"));
